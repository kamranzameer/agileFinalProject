 ...
 * 
 * This DAO class contains methods to perform actions on the database against Work Package table
 *
 */
public class WorkPackageDAO {
	...
	/*
		Get connection from DBUtil, executes select query and 
	...
	*/		
	...
	public List<WorkPackageDTO> findAllPackages() throws Exception {
		/*
		Get connection from DBUtil, executes select query. Iterates through result set, initialize new workPakcageDTO object with the 
		values returned from the database, add to the list and return the list of objects.
		*/		
	...
	public WorkPackageDTO createPackage(WorkPackageDTO workPackage)
			throws Exception {
		/*
		Get connection from DBUtil, set the parameters for the statement and executes insert query. Uses oracle sequence as primary key. 
		Returns the object that was saved to the database by using findby method. Commits the transaction and rolls back if any exception occurs.   
		*/		
	...
	public WorkPackageDTO updatePackage(WorkPackageDTO workPackage)
		...
		/*
		Get connection from DBUtil, set the parameters for the statement and executes update query with a where condition.  
		Returns the object that was updated by using findby method. Commits the transaction and rolls back if any exception occurs.   
		*/		
